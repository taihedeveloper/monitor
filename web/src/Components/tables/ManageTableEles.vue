<template>
	<div class="alarmPolicy" title="页面元素">
		<div class="button-area">
			<button class="add-blue-button" @click="newAddCase"><span></span>新建页面元素case</button>
					...
					<tr v-for="(item,index) in tableHttp">
						...
						<td>
							<template v-if="item.status==1">
								...
								<a href="javascript:;" @click="deleteComfirm(2,$event)" :data-id="item.id" :data-index="index">删除</a>
							</template>
		...
		<!-- <DialogsAddEles :editinitformdata="editGetFormData"></DialogsAddEles> -->
		<DialogsAddEles :editinitelesformData="editGetFormData"></DialogsAddEles>
	</div>
</template>
<script>
import {mapGetters,mapActions} from 'vuex'
import DialogsAddEles from "../dialogs/DialogsAddEles.vue"
